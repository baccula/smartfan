...
metadata {
    ...
    tiles(scale: 2) {
        ...
        standardTile("fanoff", "device.switch", width: 2, height: 2, inactiveLabel: false, decoration: "flat") {
            state "default", label:'FAN OFF', action:"fanOff", icon:"st.Home.home30"
        }

        main "switch"
        details(["switch","fanoff","refresh"])
    }
}
